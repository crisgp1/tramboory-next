...
export default function FooterSection() {
  ...
  const navLinks = [
    { label: "Inicio", href: "/", icon: FiHome, delay: 0, color: "text-yellow-400" },
    ...
    { label: "Contacto", href: "#contact", icon: FiPhone, delay: 0.4, color: "text-purple-400" },
  ]
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-purple-900/60 via-purple-900/80 to-black/95 pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-white font-funhouse text-center mb-3">
            <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-yellow-500">
              Tramboory
            </span>
          </h2>
          ...
          >
            <h3 className="text-xl font-bold text-white mb-6 inline-flex items-center">
              <span className="relative">
                Sobre Nosotros
                <motion.span 
                  className="absolute -bottom-1 left-0 right-0 h-px bg-gradient-to-r from-yellow-400/0 via-yellow-400/80 to-yellow-400/0"
                  animate={{ 
                    scaleX: [0, 1, 0],
                    x: [-100, 0, 100]
                  }}
