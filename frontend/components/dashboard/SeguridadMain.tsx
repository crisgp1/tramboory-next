  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-lg font-body-medium text-gray-900">
          {title}
        </h3>
      </div>
      {children}
      ...
      {activeTab === 'logs' ? (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-xl font-semibold text-gray-900 font-body-medium">Registro de Actividad</h3>
            <p className="text-sm text-gray-500 font-body-light">Últimas actividades de seguridad del sistema</p>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-body-medium text-gray-500 uppercase tracking-wider">
                    Estado
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-body-medium text-gray-500 uppercase tracking-wider">
                    Acción
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {securityLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-body-medium text-gray-900">{log.action}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-body-medium text-gray-900">{log.user}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500 font-body-light">{log.timestamp}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500 font-body-light">{log.ipAddress}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-500 font-body-light">{log.details}</div>
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        <div className="space-y-8">
          ...
          <SettingsCard title="Política de Contraseñas" icon={<KeyIcon />}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-body-medium text-gray-700 mb-2">
                  Longitud mínima
                </label>
                <input
                  type="number"
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-tramboory-purple-500 focus:border-transparent transition-all duration-200"
            ...
            <div className="mt-4 space-y-2">
              <label className="flex items-center">
                <input
                  ...
                  className="rounded border-gray-300 text-tramboory-purple-600 focus:ring-tramboory-purple-500"
                  title="Requerir mayúsculas"
                />
                <span className="ml-2 text-sm text-gray-700 font-body-light">Requerir mayúsculas</span>
              </label>
              <label className="flex items-center">
                <input
                  type="checkbox"
                ...
                />
                <span className="ml-2 text-sm text-gray-700 font-body-light">Requerir números</span>
              </label>
              <label className="flex items-center">
                <input
                  type="checkbox"
                ...
                />
                <span className="ml-2 text-sm text-gray-700 font-body-light">Requerir símbolos</span>
              </label>
            </div>
          </SettingsCard>
          ...
          <SettingsCard title="Configuración de Sesiones" icon={<ClockIcon />}>
            ...
            <div className="mt-4">
              <label className="flex items-center">
                ...
                />
                <span className="ml-2 text-sm text-gray-700 font-body-light">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="bg-tramboory-purple-600 hover:bg-tramboory-purple-700 text-white font-bold py-2 px-6 rounded-xl transition-all duration-200 hover:shadow-md hover:scale-105 transform font-body-medium"
