...
export function PromotionsSection({ promocionesImages }: PromotionsSectionProps) {
  ...
  return (
    ...
    >
      {/* BLUR EFFECT PERMANENTE - IMPLEMENTACIÓN CORREGIDA */}
      <div 
        className="absolute inset-0 opacity-100 pointer-events-none -z-5"
        style={{
      ...
      <div className="container mx-auto px-6">
        ...
        {/* Línea decorativa con gradiente - ANIMACIÓN CORREGIDA */}
        <motion.div 
            ...
            {promocionesImages.map((imageUrl, index) => (
              <motion.div
                ...
                className="min-w-[320px] h-[420px] mx-4 rounded-2xl overflow-hidden flex-shrink-0 snap-center
                  shadow-2xl transform transition-all duration-500 group/card relative
              ...
              >
                {/* HOVER BLUR INDIVIDUAL POR TARJETA */}
                <div 
                  className="absolute inset-0 opacity-0 group-hover/card:opacity-100 transition-opacity duration-500 pointer-events-none"
                  style={{
                    background: `linear-gradient(
                      135deg,
                      oklch(43.8% 0.218 303.724 / 0.3) 0%,
                      oklch(43.8% 0.218 303.724 / 0.1) 50%,
                      oklch(43.8% 0.218 303.724 / 0.3) 100%
                    )`
                  }}
                />
                ...
                <div className="relative w-full h-full overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-tramboory-purple-900/30 to-transparent opacity-0 group-hover/card:opacity-100 transition-opacity duration-500 pointer-events-none" />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-2 group-hover/card:translate-y-0 transition-transform duration-500">
                    ...
                    <p className="text-gray-300 mb-4 opacity-0 group-hover/card:opacity-100 transition-opacity duration-500">
