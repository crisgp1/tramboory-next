        ...
        >
          ...
          >
            <span className="group relative px-5 py-2 rounded-full text-sm font-medium 
              bg-gradient-to-r from-tramboory-purple-500/20 via-tramboory-purple-600/20 to-tramboory-purple-500/20 
          ...
          >
            {promocionesImages.map((imageUrl, index) => (
              <motion.div
                ...
                whileHover={{ 
                  y: -10, 
                  boxShadow: "0 125px 50px -12px rgba(0, 0, 0, 0.5)",
                  scale: 1.02
                }}
                style={{ 
                  willChange: 'transform',
              ...
              >
                <div className="relative w-full h-full overflow-hidden">
                  ...
                  {/* Sistema de overlays con gradiente y blur */}
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent pointer-events-none" />
                  <div className="absolute inset-0 bg-gradient-to-br from-tramboory-purple-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none backdrop-blur-sm" />
