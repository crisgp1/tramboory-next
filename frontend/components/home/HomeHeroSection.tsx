    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          animate={controls}
          custom={0}
          className="absolute -top-32 -right-32 w-80 h-80 bg-gradient-to-br from-tramboory-purple-400/20 to-tramboory-purple-600/10 rounded-full blur-3xl"
        />
        <motion.div
          initial={{ opacity: 0, scale: 0.9 }}
          animate={controls}
          custom={1}
          className="absolute top-1/4 -left-16 w-40 h-40 bg-gradient-to-tr from-tramboory-yellow-400/25 to-transparent rounded-full blur-2xl"
        />
        <motion.div
          initial={{ opacity: 0, scale: 0.9 }}
          animate={controls}
          custom={2}
          className="absolute bottom-16 right-16 w-56 h-56 bg-gradient-to-tl from-tramboory-purple-500/15 to-transparent rounded-full blur-2xl"
        />
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold
              bg-gradient-to-r from-tramboory-purple-500/25 to-tramboory-purple-600/20 
              text-tramboory-yellow-300 border border-tramboory-purple-400/40 backdrop-blur-md
              hover:border-tramboory-yellow-400/60 transition-all duration-300">
            ...
            <span className="block">
              ...
              <span className="relative inline-block">
                <span className="text-gradient bg-clip-text text-transparent
                  bg-gradient-to-r from-tramboory-yellow-300 via-tramboory-yellow-400 to-tramboory-yellow-500">
                  Tramboory
                </span>
              </span>
            </span>
          ...
          >
            ...
            >
              <Link
                href="/reservas"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-tramboory-yellow-400 to-tramboory-yellow-500
                  text-tramboory-purple-900 rounded-xl font-bold text-lg shadow-xl
                  hover:from-tramboory-yellow-500 hover:to-tramboory-yellow-600 hover:shadow-tramboory-yellow-400/25
      ...
      {/* Bidirectional purple overlay */}

{/* Corrected bidirectional purple overlay - opaque center, transparent edges */}

{/* Violet overlay: transparent edges, opaque center */}
<div className="absolute inset-0 bg-gradient-to-b from-transparent via-purple-600/40 to-transparent pointer-events-none" /> </section>
  )
}