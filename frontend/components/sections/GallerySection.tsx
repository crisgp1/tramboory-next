...
/**
 * Gallery section with advanced animations and enhanced visual effects
 * 
 * Features:
 * - Interactive image carousel with navigation
 * - Scroll-based animations and parallax effects
 * - Image selection and focus functionality
 * - Responsive image display optimized for Next.js
 * - Tramboory theme styling
 */
export function GallerySection({ carouselImages }: GallerySectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-indigo-900/30 via-tramboory-purple-900/30 to-indigo-900/30 pointer-events-none" />
      ...
      <div className="absolute bottom-0 inset-x-0 h-64 bg-gradient-to-t from-tramboory-purple-900/20 to-transparent pointer-events-none" />
    </section>
  )
}